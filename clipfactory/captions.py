...
STYLES = {
    "hormozi": {
        ...
        "note": "Белый текст, активное слово жёлтое. Самый распространённый стиль.",
    },
    "threestate": {
        ...
        "words_per_chunk": 3, "upper": True,
        "note": "Три состояния: сказанное белым, текущее янтарным, будущее серым.",
    },
    "pill": {
        ...
        "pill_bg": "#FF2D55",
        "words_per_chunk": 3, "upper": True,
        "note": "Активное слово на плашке. Плашка рисуется отдельным слоем.",
    },
    "neon": {
        "font": "Anton", "size": 94, "bold": 0,
        ...
        "note": "Неоновый контур с тенью-свечением, активное слово голубое.",
    },
}
