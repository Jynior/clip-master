...
- [Зафиксированные параметры](#зафиксированные-параметры) — [видео](#видео) · [субтитры](#субтитры) · [звук](#звук) · [безопасные зоны](#безопасные-зоны-tiktok-на-1080×1920)
...
| **threestate** | Сказанное белое, текущее янтарное `#F59E0B`, будущее приглушённо-серое `#8E8E9C`. Видно, сколько осталось до конца фразы. Anton 94, 3 слова | Длинные фразы и плотная речь: серый цвет будущих слов не даёт дочитать вперёд голоса |
...
| **neon** | Тонкая голубая обводка 3 px с тенью-свечением вместо толстой чёрной, активное слово `#00FFFF`. Anton 94, 2 слова на показ | Тёмный и ночной материал, гейминг. **На светлом фоне не использовать** — тонкая обводка не держит контраст |
